...
test('WRITING_SETS has all 5 languages with 5 words each', () => {
...
test('evaluateHandwriting handles exact matches for all 5 languages', () => {
  const langs = ['en', 'ta', 'te', 'kn', 'hi'];
  for (const lang of langs) {
...
test('evaluateHandwriting accepts fuzzy / punctuation-padded OCR text across all 5 languages', () => {
  const testCases = [
...
test('evaluateHandwriting accepts single letter practice strokes for all 5 languages', () => {
  const singleLetters = [
